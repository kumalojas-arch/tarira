...
export const TariraConnectModule: React.FC<TariraConnectModuleProps> = (props) => {
  ...
  const [isHireJobModalOpen, setIsHireJobModalOpen] = useState(false);
  ...
  return (
    <div id="s-connect-sub" className="flex-1 flex flex-col w-full animate-fade-up max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-4 pb-16 text-slate-800 font-sans">
      ...
      <section className="relative rounded-3xl overflow-hidden mb-12 shadow-xl border border-blue-900/30 bg-[#172554] min-h-[480px] sm:min-h-[520px] flex items-center">
        ...
        <div className="relative z-10 p-6 sm:p-12 lg:p-14 max-w-3xl text-left text-white w-full">
          ...
          <div className="flex flex-wrap items-center gap-3.5 pt-1 mb-8">
            ...
            <button
              type="button"
              id="btn-connect-contratar-vaga"
              onClick={() => setIsHireJobModalOpen(true)}
              className="inline-flex items-center gap-2 px-5 py-3.5 rounded-xl bg-white text-[#172554] font-black text-xs uppercase tracking-wider transition-all shadow-md hover:bg-blue-50 cursor-pointer active:scale-[0.98]"
            >
              <Building2 className="w-4 h-4 text-[#172554]" />
              <span>Contratar ou Abrir Vaga</span>
            </button>
      ...
      <div className="rounded-3xl p-6 sm:p-8 bg-gradient-to-r from-[#172554] via-[#1e3a8a] to-[#172554] text-white shadow-xl border border-blue-900/40 mb-12 flex flex-col md:flex-row items-center justify-between gap-6">
        <div className="space-y-2 text-left max-w-2xl">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-blue-400/20 border border-blue-300/30 text-blue-200 text-xs font-mono font-bold uppercase tracking-wider">
            ...
            <span>Empresas & Condomínios • TARIRA Connect</span>
          </div>
          <h3 className="text-xl sm:text-2xl font-serif font-bold text-white">
            Precisa de contratar técnicos ou abrir uma vaga técnica?
          </h3>
          <p className="text-xs sm:text-sm text-blue-100 font-normal leading-relaxed">
            A Tarira Connect aloca eletricistas, canalizadores, técnicos de AVAC e mestres de obras certificados com seguro de responsabilidade, supervisão presencial e SLA de 24h a 48h.
          </p>
        </div>
        <div className="flex flex-col sm:flex-row items-center gap-3 shrink-0 w-full md:w-auto">
          ...
          >
            <Building2 className="w-4 h-4 text-[#172554]" />
            <span>Requisitar Técnicos / Vaga</span>
          </button>
        </div>
      </div>
      ...
      {/* 🌟 Modal: Precisa de contratar ou abrir uma vaga */}
