...
const DEFAULT_SEED_VACANCIES: JobVacancyState[] = [
  ...
  },
  {
    ...
    type: 'Contrato Técnico de Curta, Média e Longa Duração',
  ...
  },
  {
    ...
    status: 'sourcing',
    statusLabel: 'Sourcing Ativo',
    summary: 'Gestão operacional de unidades de processamento agrícola, linhas de frio, expedição de produtos e relacionamento comercial com cooperativas.',
    requirements: ['Formação em Agronomia, Engenharia Agroindustrial ou Gestão', 'Experiência em gestão de armazéns e perecíveis', 'Residência ou disponibilidade para Chimoio'],
    expectedOpenings: '1 posição executiva sénior',
    isMockup: true,
    createdAt: new Date().toISOString()
  }
];

const jobVacancies: JobVacancyState[] = [...DEFAULT_SEED_VACANCIES];
