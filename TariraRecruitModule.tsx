...
export const TariraRecruitModule: React.FC<TariraRecruitModuleProps> = (props) => {
  ...
  return (
    <div id="s-recruit-sub" className="flex-1 flex flex-col w-full animate-fade-up max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-4 pb-20 text-text-primary font-sans">
        ...
        <div className="relative h-[420px] sm:h-[480px] lg:h-[520px] w-full overflow-hidden">
          ...
          <div className="absolute inset-0 z-10 p-6 sm:p-12 lg:p-16 flex flex-col justify-end sm:justify-center max-w-4xl text-left">
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3.5">
              ...
              <button
                type="button"
                id="btn-recruit-banner-abrir-vaga"
                onClick={() => setIsHireJobModalOpen(true)}
                className="inline-flex items-center justify-center gap-2 px-6 py-4 rounded-xl bg-white text-[#172554] border border-white text-xs font-black uppercase tracking-wider transition-all shadow-md hover:bg-blue-50 cursor-pointer active:scale-[0.98]"
              >
      ...
      <div className="rounded-3xl p-6 sm:p-8 bg-gradient-to-r from-[#172554] via-[#1e3a8a] to-[#172554] text-white shadow-xl border border-blue-900/40 mb-14 flex flex-col md:flex-row items-center justify-between gap-6">
        <div className="space-y-2 text-left max-w-2xl">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-blue-400/20 border border-blue-300/30 text-blue-200 text-xs font-mono font-bold uppercase tracking-wider">
            <Sparkles className="w-3.5 h-3.5 text-blue-300" />
            <span>Empresas & Organizações • TARIRA Recruit</span>
          </div>
          <h3 className="text-xl sm:text-2xl font-serif font-bold text-white">
            Precisa de contratar ou abrir uma vaga corporativa?
          </h3>
          <p className="text-xs sm:text-sm text-blue-100 font-normal leading-relaxed">
            A Tarira faz a triagem rigorosa de competências, validação de diplomas e alocação de profissionais qualificados com SLA garantido de 24h a 48h e reposição assegurada.
          </p>
        </div>
