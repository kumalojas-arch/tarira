            ...
            {isUserAuthenticated ? (
              ...
              <div className="flex items-center gap-1.5 sm:gap-2 shrink-0 z-10">
                <button
                  ...
                  className="flex items-center gap-1 text-white hover:text-white font-bold py-1 sm:py-1.5 px-2.5 sm:px-3.5 rounded-full bg-white/10 hover:bg-white/20 border border-white/25 transition-all text-xs cursor-pointer shadow-xs shrink-0 whitespace-nowrap active:scale-95"
